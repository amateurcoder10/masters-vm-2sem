/* A Simple Virtual Machine to find min and max */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <assert.h>
...
enum        Ops         { HLT,   MOV ,  ADD ,  SUB ,  JNZ ,  JMR,   MPC,  CMP,JC,JMP};
const char *ops_str[] = {"HLT", "MOV", "ADD", "SUB", "JNZ", "JMR", "MPC", "CMP","JC","JMP"};
...
static void op_JC(struct PU *pcore)
...
static unsigned char ROM[64] = {
	...
	MOV,  addr_(63), reg_(0),	// find gcd of addr 63 and 62
	MOV,  addr_(62), reg_(1),
	CMP,  reg_(0),   reg_(1),//reg2-reg1;carry flag is set if reg2<reg1
	JNZ,   num_(15),
	MOV,  reg_(0),   addr_(61),	// reg0 is the gcd which is moved to a61
	HLT,		
	JC,num_(22) ,	
	SUB,   reg_(1),reg_(0),
	JMP,    num_(6),
