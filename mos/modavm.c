...
enum        Ops         { HLT,   MOV ,  ADD ,  SUB ,  JNZ ,  JMR,   MPC,  CMP,JC};
const char *ops_str[] = {"HLT", "MOV", "ADD", "SUB", "JNZ", "JMR", "MPC", "CMP","JC"};
...
static unsigned char ROM[64] = {
	...
	MOV,  addr_(63), reg_(1),	// find min of addr 63 and 62
	MOV,  addr_(62), reg_(2),
	CMP,  reg_(2),   reg_(1),//reg2-reg1;carry flag is set if reg2<reg1
	JC,   num_(18),
	MOV,  reg_(1),   addr_(60),	// reg1 is smaller
	MOV,  reg_(2),addr_(61),
	HLT,		// save PC in reg3
	MOV,  reg_(2),   addr_(60),	// reg2 is smaller
	MOV,  reg_(1),addr_(61),
	HLT,
